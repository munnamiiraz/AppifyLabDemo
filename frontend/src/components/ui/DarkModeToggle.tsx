...
const DarkModeToggle = () => {
  ...
  useEffect(() => {
    ...
    if (layout) {
      layout.classList.toggle('_dark_wrapper', isDarkMode);
    }
  }, []);
  ...
  return (
    <div className="_layout_mode_swithing_btn">
      <button type="button" className="_layout_swithing_btn_link" onClick={toggleMode}>
        <div className="_layout_swithing_btn">
          <div className={`_layout_swithing_btn_round ${darkMode ? '_active' : ''}`}></div>
        </div>
