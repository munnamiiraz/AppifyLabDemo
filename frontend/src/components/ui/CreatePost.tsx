...
const CreatePost = () => {
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (imageFiles.length === 0) {
      dispatch(setError('Please select image files'))
      return
    }

    if (imageFiles.length + media.length > 4) {
      dispatch(setError(`Maximum 4 images allowed. You can add ${4 - media.length} more.`))
      return
    }

    dispatch(addMedia(imageFiles))
  ...
  const handlePostSubmit = async () => {
    ...
    if (!content.trim() && media.length === 0) {
      dispatch(setError('Post must contain text or at least one photo'))
      return
    }
    ...
    try {
      ...
      dispatch(setError('Failed to create post. Please try again.'))
    }
  }
  return (
    <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <div className="_feed_inner_text_area_box">
        <div className="_feed_inner_text_area_box_image">
          <img src="https://www.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-600nw-2281862025.jpg" alt="Image" className="_txt_img" />
        </div>
        <div className="form-floating _feed_inner_text_area_box_form ">
          ...
          ></textarea>
          <label className="_feed_textarea_label" htmlFor="floatingTextarea" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            Write something ...
      ...
      <div className="_feed_inner_text_area_bottom">
        <div className="_feed_inner_text_area_item">
          ...
          <div className="_feed_inner_text_area_bottom_video _feed_common">
            <button type="button" className="_feed_inner_text_area_bottom_photo_link" disabled> <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">   <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
          ...
          <div className="_feed_inner_text_area_bottom_article _feed_common">
            <button type="button" className="_feed_inner_text_area_bottom_photo_link" disabled> <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img"> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none" viewBox="0 0 18 20">
        ...
        <div className="_feed_inner_text_area_btn">
          ...
          >
            ...
            </svg> <span>{isLoading ? 'Posting...' : 'Post'}</span>
          </button>
        </div>
      </div>
      {/* For Desktop */}
